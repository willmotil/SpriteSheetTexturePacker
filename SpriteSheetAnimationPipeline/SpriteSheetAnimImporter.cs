...
namespace SpriteSheetAnimationPipeline
{
    ...
    ///
    [ContentImporter(".spr", DefaultProcessor = "SpriteSheetAnimProcessor", DisplayName = "SpriteSheetAnimImporter")]
    public class SpriteSheetAnimImporter : ContentImporter<SpriteSheetAnimContent>
    {
        public override SpriteSheetAnimContent Import(string filename, ContentImporterContext context)
        {
            ...
            SpriteSheetAnimContent ssc = new SpriteSheetAnimContent();
