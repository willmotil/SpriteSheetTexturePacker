...
namespace SpriteSheetAnimationPipeline
{
    ...
    /// </summary>
    [ContentProcessor(DisplayName = "SpriteSheetAnimProcessor")]
    public class SpriteSheetAnimProcessor : ContentProcessor<SpriteSheetAnimContent, SpriteSheetAnimContent>
    {
        //[DisplayName("Scale")]
        //[DefaultValue(1)]
        //[Description("Set the scale of the model.")]
        //public float Scale { get; set; }
        public SpriteSheetAnimProcessor()
        {
        ...
        public override SpriteSheetAnimContent Process(SpriteSheetAnimContent input, ContentProcessorContext context)
        {
            try
            {
