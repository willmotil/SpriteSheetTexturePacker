...
namespace SpriteSheetXnbReader
{
    // We read in the xnb.
    public class SpriteSheetAnimReader : ContentTypeReader<SpriteSheetAnim>
    {
        protected override SpriteSheetAnim Read(ContentReader input, SpriteSheetAnim existingInstance)
        {
            SpriteSheetAnim ss = new SpriteSheetAnim();
            ...
            {
                var sprite = new SpriteSheetAnim.Sprite();
            ...
            ss.sets = new List<SpriteSheetAnim.Set>();
            for (int i = 0; i < setlen; i++)
            {
                SpriteSheetAnim.Set set = new SpriteSheetAnim.Set();
